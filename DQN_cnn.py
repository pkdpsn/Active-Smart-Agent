...
def main():
    ...
    i = 0
    model = DQN("MultiInputPolicy", env, batch_size=256, gamma=0.7, learning_rate=0.001,exploration_fraction=0.2, buffer_size=200000,
                learning_starts=1000, target_update_interval=1000, train_freq=8, verbose=1, tensorboard_log=logdir,
                policy_kwargs={"features_extractor_class": CustomCombinedExtractor, "activation_fn": th.nn.Tanh, "net_arch": [256, 256]})
